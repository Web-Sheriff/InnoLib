...
urlpatterns = [
    ...
    url(r'^signup_professor', views.signup_professor, name='signup_professor'),
    url(r'^signup_instructor', views.signup_instructor, name='signup_instructor'),
    url(r'^signup_visiting_professor', views.signup_visiting_professor, name='signup_visiting_professor'),
    url(r'^signup_ta', views.signup_ta, name='signup_ta'),
    url(r'^signup_librarian', views.signup_librarian, name='signup_librarian'),
    url(r'^signup_admin', views.signup_ta, name='signup_admin'),
