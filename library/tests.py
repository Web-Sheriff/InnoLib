...
class FirstTestCase(TestCase):
    ...
    #
    # librarian = admin.add_librarian(login='librarian', password='12345', mail='test@gmail.com', first_name='Librarian', second_name='Librairain', address='Inno', phone_number='1235435', level_of_privileges=3)
    # librarian.save()
    ...
    # a4 = Author.objects.create(name='Tolstoy')
    # a5 = Author.objects.create(name='Bulgakov')
    # a6 = Author.objects.create(name='Pushkin')
    # a7 = Author.objects.create(name='King')
    # a8 = Author.objects.create(name='Chekhov')
    # a9 = Author.objects.create(name='Shakespear')
    # a10 = Author.objects.create(name='Gogol')
    # a11 = Author.objects.create(name='Dostoevsky')
    #
    ...
    # s1.search_by_availability(b2)
    # s1.search_by_availability(b3)
    # s1.search_by_availability(b4)
    # s1.search_by_availability(b5)
    # s1.search_by_availability(b6)
    # s1.search_by_availability(b7)
    # s1.search_by_availability(b8)
    # s1.search_by_availability(b9)
    # s1.search_by_availability(b10)
    # s1.search_by_availability(b11)
