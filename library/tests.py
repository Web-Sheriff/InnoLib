...
class FirstTestCase(TestCase):
    ...
    #
    # b1 = librarian.create_book_new(library=library, title='NARUTO', price_value='50', is_best_seller=False, edition='4th', publisher='ddd', year='1999', reference=False, authors=authors1)
    # b1.save()
    # librarian.create_copies(b1, 2)
    # b2 = librarian.create_book_new(library=library, is_best_seller=True, title='BORUTO', price_value='55', edition='1th', publisher='Masashi', year='2017', reference=False, authors=authors2)
    # b2.save()
    ...
    librarian.outstanding_request(b1)
